...
- Enter Reflections: Replaced the `enter` in the **Reflections** section below, within this file. This workflow fails till you replace it with your impressions.
...
You have seen a few workflows in this repository. They are quality-gates to prevent duplication, control complexity and prove functionality. Do you think some of them have potential to guide code-improvements in your team? **yes/no. This sounds wonderful!**

During the next four weeks, what improvement do you plan in your code-quality practice? (in your regular work, not in this repository!)
**I don't think that it is possible to control complexity. But, my first step would be to educate the team on "coding correctly". Currently this is not really followed and the mindset is to "get it done at any cost" rather than worrying about the quality of the code.**
